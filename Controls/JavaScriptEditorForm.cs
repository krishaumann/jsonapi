...
{
	public partial class JavaScriptEditorForm : Form
	{
		public string fileName = "";
		public bool isDirty = false;
		ScintillaNET.Scintilla TextArea;

		public JavaScriptEditorForm(string text)
		{
			InitializeComponent();
			this.Icon = Properties.Resources.jsonapi;
			var tempArray = text.Split("\\");
			string testName = tempArray[tempArray.Length - 1].ToString();
			string testInput = Utilities.TestSuite.GetTestInput(testName);
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			{
				Utilities.Logs.NewLogItem("Scintilla issue: " + textAreaException.Message, System.Diagnostics.TraceEventType.Error);
			}
			...
			// DEFAULT FILE, otherwise saved value
			if (File.Exists(this.fileName))
				LoadDataFromFile(this.fileName);
			else
            {
				FileName.Text = this.fileName;
				TextArea.Text = Utilities.TestSuite.GetTestInput(this.fileName);
				if (TextArea.Text.Length > 0) executeScriptToolStripMenuItem.Enabled = true;
			}
		...
		private void InitHotkeys()
		{
			...
			Utilities.HotKeyManager.AddHotKey(this, OpenSearch, Keys.F, true);
			Utilities.HotKeyManager.AddHotKey(this, OpenFindDialog, Keys.F, true, false, true);
			Utilities.HotKeyManager.AddHotKey(this, OpenReplaceDialog, Keys.R, true);
			Utilities.HotKeyManager.AddHotKey(this, OpenReplaceDialog, Keys.H, true);
			Utilities.HotKeyManager.AddHotKey(this, Uppercase, Keys.U, true);
			Utilities.HotKeyManager.AddHotKey(this, Lowercase, Keys.L, true);
			Utilities.HotKeyManager.AddHotKey(this, ZoomIn, Keys.Oemplus, true);
			Utilities.HotKeyManager.AddHotKey(this, ZoomOut, Keys.OemMinus, true);
			Utilities.HotKeyManager.AddHotKey(this, ZoomDefault, Keys.D0, true);
			Utilities.HotKeyManager.AddHotKey(this, CloseSearch, Keys.Escape);
		...
		private void saveToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (saveValue)
			{
				...
				executeScriptToolStripMenuItem.Enabled = true;
				this.isDirty = false;
			}
			else MessageBox.Show("Script not saved successfully.");
		}

		private void closeToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (this.isDirty) MessageBox.Show("Please save all changes made to the file.");
			else this.Close();
		}

		private void executeToolStripMenuItem_Click(object sender, EventArgs e)
		{
			var returnValue = Utilities.Utilities.ExecuteJavaScript(this.fileName);
		...
		{
			Utilities.HotKeyManager.Enable = false;
			TextArea.Focus();
			SendKeys.Send(keys);
			Utilities.HotKeyManager.Enable = true;
		}
		...
		private void OpenSearch()
		{
			...
			Utilities.SearchManager.SearchBox = TxtSearch;
			Utilities.SearchManager.TextArea = TextArea;
			...
			if (!SearchIsOpen)
			{
				...
				InvokeIfNeeded(delegate () {
					...
					TxtSearch.Text = Utilities.SearchManager.LastSearch;
					TxtSearch.Focus();
					TxtSearch.SelectAll();
				});
			}
		...
		{
			Utilities.SearchManager.Find(false, false);
		}
		private void BtnNextSearch_Click(object sender, EventArgs e)
		{
			Utilities.SearchManager.Find(true, false);
		}
		private void TxtSearch_TextChanged(object sender, EventArgs e)
		{
			Utilities.SearchManager.Find(true, true);
		}

		private void TxtSearch_KeyDown(object sender, KeyEventArgs e)
		{
			if (Utilities.HotKeyManager.IsHotkey(e, Keys.Enter))
			{
				Utilities.SearchManager.Find(true, false);
			}
			if (Utilities.HotKeyManager.IsHotkey(e, Keys.Enter, true) || Utilities.HotKeyManager.IsHotkey(e, Keys.Enter, false, true))
			{
				Utilities.SearchManager.Find(false, false);
			}
		}
